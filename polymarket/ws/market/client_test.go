...
func TestClient_ReadMessage_IgnoresRawPONGHeartbeat(t *testing.T) {
	t.Parallel()
...
func TestClient_ReadMessage_ReturnsTypedDecodeErrorForUnknownExplicitBatch(t *testing.T) {
	t.Parallel()
...
func TestClient_ReadMessage_ReturnsTypedDecodeErrorForFallbackAndUnknownExplicitBatch(t *testing.T) {
	t.Parallel()
